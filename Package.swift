...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/ezoic/ezoic-swift-sdk-dist/releases/download/1.2.0/EzoicAdsSDK-1.2.0.xcframework.zip",
            checksum: "24d1165d3be0463dc897c2769772f6ecbe751258f5292593a341eedb4fc00be7"
        ),
