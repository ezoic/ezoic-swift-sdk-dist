...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/ezoic/ezoic-swift-sdk-dist/releases/download/1.6.1/EzoicAdsSDK-1.6.1.xcframework.zip",
            checksum: "b952ed772d43ee4eef247404be24c3d79bc2711f1cdadf12a0174f2aa228f979"
        ),
