...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/ezoic/ezoic-swift-sdk-dist/releases/download/1.0.0-rc7/EzoicAdsSDK-1.0.0-rc7.xcframework.zip",
            checksum: "d6c4d33113d6ec55d27822ae0a9bda8f5ad1aca8837ad97b795db028148750f5"
        ),
