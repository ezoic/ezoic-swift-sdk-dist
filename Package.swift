...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/ezoic/ezoic-swift-sdk-dist/releases/download/1.0.0-rc8/EzoicAdsSDK-1.0.0-rc8.xcframework.zip",
            checksum: "1d07d3ff8b174ab97a8ede27819681fce14223a04aad91b3ec32af3fddf8a839"
        ),
